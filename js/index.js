...
function cartInfo() {
    ...
    var tableBody = document.getElementById("thanhToan"); // Đây là tbody trong modal
    var totalCell = document.getElementById("tinhTong"); // Đây là cell hiển thị tổng thanh toán
